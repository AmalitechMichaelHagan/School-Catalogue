...
//Only sets value if passed parameter is a number
isNaN(param) == false? this._numberOfStudents = param : console.log('Invalid input: numberOfStudents must be set to a Number.');
